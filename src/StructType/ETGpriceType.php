...
class ETGpriceType extends AbstractStructBase
{
     ...
     * @param \Autovista\Identification\StructType\ETGdateType $amountDate
     * @param string $indicator
     */
    public function __construct($amount = 0, $iSOcurrencyCode = null, \Autovista\Identification\StructType\ETGdateType $amountDate = null, $indicator = null)
    {
        $this
            ->setAmount($amount)
     ...
     * Set Amount value
     * @param double $amount
     * @return \Autovista\Identification\StructType\ETGpriceType
     */
     ...
     * @return \Autovista\Identification\StructType\ETGpriceType
     */
    public function setAmountDate(\Autovista\Identification\StructType\ETGdateType $amountDate = null)
    {
