...
/**
 * This class stands for GetListBodyType StructType
 * @subpackage Structs
 */
class GetListBodyType extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListBodyType
     * @uses GetListBodyType::setSettings()
     * @uses GetListBodyType::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListBodyType
     */
