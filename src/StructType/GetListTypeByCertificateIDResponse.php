...
/**
 * This class stands for GetListTypeByCertificateIDResponse StructType
 * @subpackage Structs
 */
class GetListTypeByCertificateIDResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListTypeByCertificateIDResponse
     * @uses GetListTypeByCertificateIDResponse::setSettings()
     * @uses GetListTypeByCertificateIDResponse::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListTypeByCertificateIDResponse
     */
