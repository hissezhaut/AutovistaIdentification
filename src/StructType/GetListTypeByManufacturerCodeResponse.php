...
/**
 * This class stands for GetListTypeByManufacturerCodeResponse StructType
 * @subpackage Structs
 */
class GetListTypeByManufacturerCodeResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListTypeByManufacturerCodeResponse
     * @uses GetListTypeByManufacturerCodeResponse::setSettings()
     * @uses GetListTypeByManufacturerCodeResponse::setVehicleList()
     ...
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return
     * \Autovista\Identification\StructType\GetListTypeByManufacturerCodeResponse
     */
