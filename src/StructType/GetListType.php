...
/**
 * This class stands for GetListType StructType
 * @subpackage Structs
 */
class GetListType extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListType
     * @uses GetListType::setSettings()
     * @uses GetListType::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListType
     */
