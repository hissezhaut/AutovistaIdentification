...
/**
 * This class stands for GetListGearBoxType StructType
 * @subpackage Structs
 */
class GetListGearBoxType extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListGearBoxType
     * @uses GetListGearBoxType::setSettings()
     * @uses GetListGearBoxType::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListGearBoxType
     */
