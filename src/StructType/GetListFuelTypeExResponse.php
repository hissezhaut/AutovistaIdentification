...
/**
 * This class stands for GetListFuelTypeExResponse StructType
 * @subpackage Structs
 */
class GetListFuelTypeExResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListFuelTypeExResponse
     * @uses GetListFuelTypeExResponse::setSettings()
     * @uses GetListFuelTypeExResponse::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListFuelTypeExResponse
     */
