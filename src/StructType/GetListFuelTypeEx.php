...
/**
 * This class stands for GetListFuelTypeEx StructType
 * @subpackage Structs
 */
class GetListFuelTypeEx extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListFuelTypeEx
     * @uses GetListFuelTypeEx::setSettings()
     * @uses GetListFuelTypeEx::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListFuelTypeEx
     */
