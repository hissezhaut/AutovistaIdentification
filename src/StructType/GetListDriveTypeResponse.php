...
/**
 * This class stands for GetListDriveTypeResponse StructType
 * @subpackage Structs
 */
class GetListDriveTypeResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListDriveTypeResponse
     * @uses GetListDriveTypeResponse::setSettings()
     * @uses GetListDriveTypeResponse::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListDriveTypeResponse
     */
