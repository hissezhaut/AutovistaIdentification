...
/**
 * This class stands for GetListModelResponse StructType
 * @subpackage Structs
 */
class GetListModelResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListModelResponse
     * @uses GetListModelResponse::setSettings()
     * @uses GetListModelResponse::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListModelResponse
     */
