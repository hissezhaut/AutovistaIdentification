...
/**
 * This class stands for GetListBodyTypeResponse StructType
 * @subpackage Structs
 */
class GetListBodyTypeResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListBodyTypeResponse
     * @uses GetListBodyTypeResponse::setSettings()
     * @uses GetListBodyTypeResponse::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListBodyTypeResponse
     */
