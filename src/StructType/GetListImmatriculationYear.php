...
/**
 * This class stands for GetListImmatriculationYear StructType
 * @subpackage Structs
 */
class GetListImmatriculationYear extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $Settings;
    /**
     * Constructor method for GetListImmatriculationYear
     * @uses GetListImmatriculationYear::setSettings()
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     */
    public function __construct(\Autovista\Identification\StructType\ETGsettingType $settings = null)
    {
        $this
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListImmatriculationYear
     */
