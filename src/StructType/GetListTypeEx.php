...
/**
 * This class stands for GetListTypeEx StructType
 * @subpackage Structs
 */
class GetListTypeEx extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListTypeEx
     * @uses GetListTypeEx::setSettings()
     * @uses GetListTypeEx::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListTypeEx
     */
