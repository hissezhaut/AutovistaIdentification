...
/**
 * This class stands for GetListVehicleTypeResponse StructType
 * @subpackage Structs
 */
class GetListVehicleTypeResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListVehicleTypeResponse
     * @uses GetListVehicleTypeResponse::setSettings()
     * @uses GetListVehicleTypeResponse::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListVehicleTypeResponse
     */
