...
/**
 * This class stands for GetListFuelType StructType
 * @subpackage Structs
 */
class GetListFuelType extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListFuelType
     * @uses GetListFuelType::setSettings()
     * @uses GetListFuelType::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListFuelType
     */
