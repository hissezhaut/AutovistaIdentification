...
/**
 * This class stands for GetListModel StructType
 * @subpackage Structs
 */
class GetListModel extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListModel
     * @uses GetListModel::setSettings()
     * @uses GetListModel::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListModel
     */
