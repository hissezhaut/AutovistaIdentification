...
/**
 * This class stands for GetListVehicleType StructType
 * @subpackage Structs
 */
class GetListVehicleType extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListVehicleType
     * @uses GetListVehicleType::setSettings()
     * @uses GetListVehicleType::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListVehicleType
     */
