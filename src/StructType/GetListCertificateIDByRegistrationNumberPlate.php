...
/**
 * This class stands for GetListCertificateIDByRegistrationNumberPlate StructType
 * @subpackage Structs
 */
class GetListCertificateIDByRegistrationNumberPlate extends AbstractStructBase
{
    /**
     * The Settings
    ...
    /**
     * Constructor method for GetListCertificateIDByRegistrationNumberPlate
     * @uses GetListCertificateIDByRegistrationNumberPlate::setSettings()
     * @uses
     * GetListCertificateIDByRegistrationNumberPlate::setRegistrationNumberPlate()
