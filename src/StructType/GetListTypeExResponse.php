...
/**
 * This class stands for GetListTypeExResponse StructType
 * @subpackage Structs
 */
class GetListTypeExResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListTypeExResponse
     * @uses GetListTypeExResponse::setSettings()
     * @uses GetListTypeExResponse::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListTypeExResponse
     */
