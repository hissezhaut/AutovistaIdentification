...
/**
 * This class stands for GetListTypeResponse StructType
 * @subpackage Structs
 */
class GetListTypeResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListTypeResponse
     * @uses GetListTypeResponse::setSettings()
     * @uses GetListTypeResponse::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListTypeResponse
     */
