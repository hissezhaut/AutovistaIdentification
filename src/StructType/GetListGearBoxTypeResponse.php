...
/**
 * This class stands for GetListGearBoxTypeResponse StructType
 * @subpackage Structs
 */
class GetListGearBoxTypeResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListGearBoxTypeResponse
     * @uses GetListGearBoxTypeResponse::setSettings()
     * @uses GetListGearBoxTypeResponse::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListGearBoxTypeResponse
     */
