...
/**
 * This class stands for GetListTypeByManufacturerCode StructType
 * @subpackage Structs
 */
class GetListTypeByManufacturerCode extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListTypeByManufacturerCode
     * @uses GetListTypeByManufacturerCode::setSettings()
     * @uses GetListTypeByManufacturerCode::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListTypeByManufacturerCode
     */
