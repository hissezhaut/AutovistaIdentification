...
/**
 * This class stands for GetListMakeResponse StructType
 * @subpackage Structs
 */
class GetListMakeResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListMakeResponse
     * @uses GetListMakeResponse::setSettings()
     * @uses GetListMakeResponse::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListMakeResponse
     */
