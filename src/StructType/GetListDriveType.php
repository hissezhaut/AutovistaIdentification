...
/**
 * This class stands for GetListDriveType StructType
 * @subpackage Structs
 */
class GetListDriveType extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListDriveType
     * @uses GetListDriveType::setSettings()
     * @uses GetListDriveType::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListDriveType
     */
