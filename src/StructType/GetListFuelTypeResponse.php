...
/**
 * This class stands for GetListFuelTypeResponse StructType
 * @subpackage Structs
 */
class GetListFuelTypeResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $VehicleList;
    /**
     * Constructor method for GetListFuelTypeResponse
     * @uses GetListFuelTypeResponse::setSettings()
     * @uses GetListFuelTypeResponse::setVehicleList()
     ...
     * Set Settings value
     * @param \Autovista\Identification\StructType\ETGsettingType $settings
     * @return \Autovista\Identification\StructType\GetListFuelTypeResponse
     */
